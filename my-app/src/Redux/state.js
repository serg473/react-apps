...
let state = {
    ...
    news: {
        newsData :[
            {id: 1, src: 'https://i.ytimg.com/vi/ie53jQ2uobc/maxresdefault.jpg', title:'БЕЛАЗ проведет день открытых дверей 24 сентября', datePublish:'13.03.2022', tag: 'Политика'},
            {id: 2, src: 'https://i.ytimg.com/vi/ie53jQ2uobc/maxresdefault.jpg', title:'В здании парламента Чехии сократят время и температуру отопления', datePublish:'13.03.2022', tag: 'Экономика'},
            {id: 3, src: 'https://i.ytimg.com/vi/ie53jQ2uobc/maxresdefault.jpg', title:'Сальдо: референдум в Херсонской области реализует право на самоопределение', datePublish:'13.03.2022', tag: 'Политика'},
            {id: 4, src: 'https://i.ytimg.com/vi/ie53jQ2uobc/maxresdefault.jpg', title:'В Бельгии начали отключать освещение на автотрассах', datePublish:'13.03.2022', tag: 'Общество'}
        ],
    },
    friends:{
        friendsData :[
